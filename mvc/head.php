    ...
    <link rel="manifest" href="<?php echo $site_url; ?>/assets/images/favicons/site.webmanifest" />
    ...
    <link rel="stylesheet" href="<?php echo $site_url; ?>/assets/vendors/jetly-icons/style.css">
    ...
    <link rel="stylesheet" href="<?php echo $site_url; ?>/assets/vendors/nice-select/nice-select.css" />

    <!-- template styles -->
    <link rel="stylesheet" href="<?php echo $site_url; ?>/assets/css/fixnix.css" />
    <link rel="stylesheet" href="<?php echo $site_url; ?>/assets/css/fixnix-responsive.css" />